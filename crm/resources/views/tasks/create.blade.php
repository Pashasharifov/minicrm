                    ...
                    <form action="{{ route('tasks.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="3"
                                      class="w-full rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <button type="submit"
                                    class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Save Task</button>
                        </div>
                    </form>
